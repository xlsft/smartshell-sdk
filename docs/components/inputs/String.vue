    ...
    >
        ...
        >
            ...
            <input
                ...
                class="transition-all font-[400] outline-none disabled:opacity-50 disabled:grayscale disabled:bg-white placeholder:text-[14px] text-[14px] bg-white disabled:cursor-not-allowed text-gray-800 rounded-lg px-3 py-2 disabled:text-gray-500 placeholder-text-gray-500 w-full h-full border hover:border-indigo-500"
