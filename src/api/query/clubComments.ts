...
import type { ClubCommentPaginated, ClubCommentSearchInput } from "../../types/types.ts"
import { key } from "../../utils/key.ts"

export type InputType = { paginator?: ShellSdkPaginatorInput; input?: ClubCommentSearchInput }
export type ResponseType = ClubCommentPaginated
...
const module = async <Input extends InputType["input"], Response extends ResponseType>(
    ...
    return await ctx.request(
        ...
        [
            ...
            key("summary", ["average_grade", "unread_total", "five", "four", "three", "two", "one"]),
        ],
        { input: props },
        paginator || { page: 1 },
    )
