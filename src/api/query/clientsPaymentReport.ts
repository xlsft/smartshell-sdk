...
import type { ClientsPaymentReportPaginated, ClientsPaymentReportInput } from "../../types/types.ts"
import { key } from "../../utils/key.ts"

export type InputType = { paginator?: ShellSdkPaginatorInput; input: ClientsPaymentReportInput }
export type ResponseType = ClientsPaymentReportPaginated
    ...
    return await ctx.request(
        ...
        [
            key("data", [
                ...
                key("shop", ["value", key("currency", ["id", "title", "alias", "letter"])]),
                key("tariff", ["value", key("currency", ["id", "title", "alias", "letter"])]),
                key("bonus", ["value", key("currency", ["id", "title", "alias", "letter"])]),
                key("total", ["value", key("currency", ["id", "title", "alias", "letter"])]),
                key("average", ["value", key("currency", ["id", "title", "alias", "letter"])]),
            ]),
        ],
        { input: props },
        paginator || { page: 1 },
