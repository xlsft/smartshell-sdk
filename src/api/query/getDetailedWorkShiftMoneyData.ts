...
import type { DetailedWorkShiftMoneyData } from "../../types/types.ts"
import { key } from "../../utils/key.ts"

export type InputType = { id?: number }
export type ResponseType = DetailedWorkShiftMoneyData
...
const module = async <Input extends InputType, Response extends ResponseType>(
    ...
    return await ctx.request(
        ...
        [
            ...
            "bonus",
            "refunded",
            key("cash", ["good", "service", "tariff", "deposit", "tips"]),
            key("card", ["good", "service", "tariff", "deposit", "tips"]),
            key("cash_orders", [
                "id",
                key("work_shift", [
                    "id",
