...
import type { HostOverview } from "../../types/types.ts"
import { key } from "../../utils/key.ts"

export type ResponseType = HostOverview[]

const module = async <Response extends ResponseType>(ctx: ShellSdkContext): Promise<Response> => {
    return await ctx.request("query", "hostsOverview", [
        "id",
        "group_id",
        "type_id",
        "position",
        ...
        key("counters", ["cpu_temp", "disk_temp", key("disk_status", ["letter", "total", "used"]), "active_window"]),
        "device_has_changed",
        "locked",
        key("bookings", [
            "id",
        ...
        key("client_sessions", [
            ...
            "postpaid",
            "total_cost",
            key("seances", ["id", key("tariff", ["id", "title"])]),
        ]),
        "comment",
        "admin_called_at",
    ])
