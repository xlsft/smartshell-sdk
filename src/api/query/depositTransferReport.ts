...
import type { DepositTransferReport, DepositTransferReportInput } from "../../types/types.ts"
import { key } from "../../utils/key.ts"

export type InputType = { paginator?: ShellSdkPaginatorInput; input: DepositTransferReportInput }
export type ResponseType = DepositTransferReport
...
const module = async <Input extends InputType["input"], Response extends ResponseType>(
    ...
    return await ctx.request(
        ...
        [
            key("data", [
                key("transfer", [key("club", ["id", "name", "address"]), "sum", "created_at"]),
                key("user", [
                    "id",
                    "uuid",
